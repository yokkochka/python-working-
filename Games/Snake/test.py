...
class Snake:
    def __init__(self, fruit):
        ...
        self.head_up = pygame.image.load("Snake/images/blue_snake/head_up.png").convert_alpha()
        self.head_down = pygame.image.load("Snake/images/blue_snake/head_down.png").convert_alpha()
        self.head_left = pygame.image.load("Snake/images/blue_snake/head_left.png").convert_alpha()
        self.head_right = pygame.image.load("Snake/images/blue_snake/head_right.png").convert_alpha()

        self.snake_DownToLeft = pygame.image.load("Snake/images/blue_snake/snake_DownToLeft.png").convert_alpha()
        self.snake_DownToRight = pygame.image.load("Snake/images/blue_snake/snake_DownToRight.png").convert_alpha()
        self.snake_UpToLeft = pygame.image.load("Snake/images/blue_snake/snake_UpToLeft.png").convert_alpha()
        self.snake_UpToRight = pygame.image.load("Snake/images/blue_snake/snake_UpToRight.png").convert_alpha()
        
        self.snake_horizontal = pygame.image.load("Snake/images/blue_snake/snake_horizontal.png").convert_alpha()
        self.snake_vertical = pygame.image.load("Snake/images/blue_snake/snake_vertical.png").convert_alpha()

        self.tail_up = pygame.image.load("Snake/images/blue_snake/tail_up.png").convert_alpha()
        self.tail_down = pygame.image.load("Snake/images/blue_snake/tail_down.png").convert_alpha()
        self.tail_left = pygame.image.load("Snake/images/blue_snake/tail_left.png").convert_alpha()
        self.tail_right = pygame.image.load("Snake/images/blue_snake/tail_right.png").convert_alpha()
        
        self.bite = pygame.mixer.Sound('Snake/music/bite.ogg')
        self.music_game_over = pygame.mixer.Sound('Snake/music/game_over.ogg')
...
class Fruit:
    def __init__(self):
        ...
        # Загружаем картинку
        self.red_apple = pygame.image.load("Snake/images/fruits/red_apple.png").convert_alpha()
        ...
        self.green_apple = pygame.image.load("Snake/images/fruits/green_apple.png").convert_alpha()
        self.green_apple = pygame.transform.scale(self.green_apple, (SIZE,SIZE))
        self.green_apple.set_colorkey('white')

        self.banana = pygame.image.load("Snake/images/fruits/banana.png").convert_alpha()
        self.banana = pygame.transform.scale(self.banana, (SIZE,SIZE))
        self.banana.set_colorkey('white')

        self.orange = pygame.image.load("Snake/images/fruits/orange.png").convert_alpha()
